 ...
 */
namespace Limesharp\Stockists\Helper;
...
use Limesharp\Stockists\Model\ImageFactory;
...
class Image extends AbstractHelper
{
     ...
     * Current model
     *
     * @var \Limesharp\Stockists\Model\Image
     */
    protected $model;
     ...
     * image factory
     *
     * @var \Limesharp\Stockists\Model\ImageFactory
     */
     ...
     *
     * @see \Limesharp\Stockists\Model\Image
     * @param int $width
     * @param int $height
     * @return $this
     */
     ...
     *
     * @see \Limesharp\Stockists\Model\Image\Image
     ...
     *
     * @return \Limesharp\Stockists\Model\Image
     */
    protected function getModel()
    {
        if (!$this->model) {
            $this->model = $this->imageFactory->create(['entityCode' => 'stockist']);
        }
        return $this->model;
    }
